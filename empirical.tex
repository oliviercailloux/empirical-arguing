...
\begin{proof}
	...
	\textbf{In fact, the stated conjecture is false, because of some trees that use rebuttals. Consider $a$ undercut by $¬¬¬a$ undercut by $¬¬a$. Here, adding $¬¬¬a$ does not change anything. Similarly, with root $a$ and undercut $\set{¬b, ¬b → ¬a}$ undercut by $b$, there seems to be nothing we can add.}
\end{proof}
