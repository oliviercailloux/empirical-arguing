...
\begin{figure}
	...
	\begin{tikzpicture}
		...
		\path node (a) {(\set{a}, a)};
		\path (a) ++(-3cm, -2cm) node (na) {(\set{¬a}, ¬a)};
		\path (a) ++(3cm, -2cm) node (nnna) {(\set{¬¬¬a}, ¬a)};
		\path (na) ++(0, -2cm) node (ab1) {(\set{a \land b}, ¬(¬a))};
		\path (nnna) ++(0, -2cm) node (ab2) {(\set{a \land b}, ¬(¬¬¬a))};
		\path (ab1) ++(3cm, -2cm) node (nb) {(\set{¬b}, ¬(a \land b))};
		\path[draw, <-] (a) -- (na);
		\path[draw, <-] (a) -- (nnna);
		\path[draw, <-] (na) -- (ab1);
		\path[draw, <-] (nnna) -- (ab2);
