...
\footnote{The authors define this concept as: $(\Psi, \beta)$ \emph{defeats} $(\Phi, \alpha)$ iff $\beta ⊢ ¬(φ_1 ∧ \ldots ∧ φ_n)$ for some $\set{φ_1, \ldots, φ_n} ⊆ Φ$.}
...
%V1, not warranted (desired intuitively):
%fb and bT ⇒ fT
%bp and ¬fp ⇒ ¬fb
%
...
%¬¬fb
%
%V1, not warranted fT and fb.
%V2, not warranted fT and fb?
%
%We should mandate that a coherent claim be made, including everything that is required during the argument: fT and fb and ¬¬fb. Then nothing is warranted, in all cases.
}
...
\commentOCf{TODO: formalisme de base de la logique defeasible. Pierre nous fournit un article ou livre de base s’il en trouve un qui semble adéquat.}
