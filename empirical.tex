...
Associate to each $\Phi \subseteq \Delta$ its argument generator $u_\Phi \subseteq \allargs × \allargs$ recursively as the following successor relation (a successor relation is an irreflexive relation that . Define the predecessors of $\Phi$ as $\emptyset$. Define \commentOC{To be continued.}
